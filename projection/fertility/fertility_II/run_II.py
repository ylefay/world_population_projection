...
POSTERIOR_DISTRIBUTION_OF_PARAMETERS_PREFIX = "../../../output/estimation/fertility_III/PMMH_fertility_II_"
...
def run(country):
    ...
    #à modifier
    simulations = [fertility_II.fertility_II(initial_fertility, *tuple(thetas[i])) for i in range(N_samples)]
