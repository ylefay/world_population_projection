...
import os
from projection.fertility.fertility_II import fertility_II
from projection.fertility.fertility_II.fertility_II import from_country_specific_parameters_to_delta
...
def run(country):
    ...
    for i in range(N_samples):
        S, U_c, a, alpha_1, alpha_2, alpha_3, b, c1975, chi, d_c_star, delta_1sq, delta_2sq, delta_3sq, delta_4sq, gamma1_c, gamma2_c, gamma3_c, m_tau, psi2, s_tausq, sigma0, triangle_4, triangle_4c_star = \
            thetas[i]
        delta_c = from_country_specific_parameters_to_delta((gamma1_c, gamma2_c, gamma3_c), U_c, d_c_star,
                                                            triangle_4c_star)
        simulations.append(fertility_II.fertility_II(initial_fertility, delta_c, c1975, sigma0, S, a, b, starting_date))
